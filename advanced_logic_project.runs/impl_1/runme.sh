...
HD_PWD='C:/Users/Nivriti/OneDrive/Desktop/University/Semester 4/Advanced logic design/advanced_logic_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log instructions.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source instructions.tcl -notrace
