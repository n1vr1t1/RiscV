...
HD_PWD='C:/Users/Nivriti/Desktop/University/Semester 4/Advanced logic design/risc-v_processor/risc-v_processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log instruction_fetch_stage.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source instruction_fetch_stage.tcl -notrace
